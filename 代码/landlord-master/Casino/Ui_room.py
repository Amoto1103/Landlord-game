...
class room(QWidget, Ui_Room):
    ...
    def print_nick(self,nick):
        _translate = QtCore.QCoreApplication.translate
        self.label1.setText(_translate("room", nick[0]))
        self.label2.setText(_translate("room", nick[1]))
        self.label3.setText(_translate("room", nick[2]))
